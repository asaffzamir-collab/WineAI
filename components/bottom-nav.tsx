...
export function BottomNav() {
  ...
  return (
    <nav aria-label="Main navigation" className="fixed bottom-0 left-0 right-0 z-50 glass border-t border-ivory-300/50 shadow-[0_-2px_16px_rgb(0,0,0,0.04)] dark:border-charcoal-700/50">
