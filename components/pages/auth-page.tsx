          ...
          <CardContent className="py-8">
            ...
            <div className="relative my-5">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-ivory-400 dark:border-charcoal-700" />
              </div>
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-3 text-stone-500 dark:bg-charcoal-800 dark:text-stone-400">or</span>
              </div>
            </div>
